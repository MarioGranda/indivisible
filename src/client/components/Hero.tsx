          ...
          <FixedContainer className="mt-5 flex flex-col gap-9 pt-72 md:pt-0 justify-center w-full md:h-[540px] md:w-auto">
            ...
            <div className="flex gap-8">
              <div className="flex items-center">
                ...
                <span className="flex text-white font-source mx-4 text-2xl">+100 DAOs</span>
              </div>
              <div className="flex items-center">
                <div className="box-border h-10 w-2 border-white border-4 bg-white">
                </div>
                <span className="text-white font-source mx-4 text-2xl whitespace-nowrap">+35K Members</span>
              </div>
              <div className="flex items-center">
                <div className="box-border h-10 w-2 border-white border-4 bg-white">
                </div>
                <span className="text-white font-source mx-4 text-2xl">+100K Proposals</span>
              </div>
            </div>
          </FixedContainer>
          </div>
          <div className="flex relative mt-32 justify-center px-20 col-span-1">
            <div className="absolute inset-0 w-[250px] h-[320px] border border-white rotate-[8.9deg] rounded-xl translate-x-5 translate-y-5">
            </div>
            <DaoCard
